#let project(
  ...
  let subtitle-font = (en_serif, ..zh_kai)
  ...
  set page(numbering: "1", number-align: center, header: 
    align(left)[#text(font: header-font, title)]
  )
  ...
  align(center)[
    #block(text(font: subtitle-font, weight: "bold", 1.2em, subtitle))
    #v(0.5em)
  ]
